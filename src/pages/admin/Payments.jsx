...
export default function Payments() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0b1424]">
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-8">
        ...
        <section className="w-full border border-gray-700 p-4 md:p-5 rounded-xl shadow bg-[#0d1d33] text-white">
          ...
          <input
            ...
            className="w-full p-2.5 rounded mb-4 bg-[#0b1424] text-white border border-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500"
            value={subSearch}
          ...
          <div className="md:hidden grid grid-cols-1 gap-4">
            {subPayments.map((p) => (
              <div
                key={p._id}
                className="bg-[#0b1424] rounded-lg p-4 border border-gray-700 space-y-2"
              >
        ...
        <section className="w-full border border-gray-700 p-4 md:p-5 rounded-xl shadow bg-[#0d1d33] text-white">
          ...
          <input
            ...
            className="w-full p-2.5 rounded mb-4 bg-[#0b1424] text-white border border-gray-600 focus:outline-none focus:ring-1 focus:ring-green-500"
            value={imgSearch}
          ...
          <div className="md:hidden grid grid-cols-1 gap-4">
            {imgPayments.map((p) => (
              ...
              >
                <div className="flex justify-between items-center">
                  <p className="font-semibold text-white">{p.imageName}</p>
                  <span className="text-xs text-gray-300">
                    {new Date(p.date).toLocaleDateString()}
                  </span>
                </div>
