  ...
  return (
    <div className="min-h-screen bg-[#0b1424]">
      <div className="max-w-7xl mx-auto p-4 md:p-6">
        <h1 className="text-2xl md:text-3xl font-bold text-white mb-4 capitalize mt-16">
        ...
        <input
          ...
          className="w-full p-3 rounded mb-6 bg-[#0d1d33] text-white border border-gray-700 focus:outline-none"
          value={search}
